...
if choice1 == "left":
  ...
  if choice2 == "wait":
    choice3 = input("(*) You arrived at the island unharmed. There is a house with 3 doors, one with 'red', one 'yellow', one 'green'. Which colour do you choose\n ").lower()
    if choice3 == "red":
      ...
      print("You choose the door that does'nt exist. GAME OVER.")
  else:
